...
english = {
  ...
  "chair_eval_index":{ 
    "conference_proceedings": "Conference Proceedings",
    "session_evaluation_file": "Session Evaluation Files",
    ...
    "form_session_instructions": 'For each session you have to fill out: ',
    ...
    "files_list": "1) All Files",
    "sorted_files_by_session": 'Concatenated files in a folder, sorted by session: ',
    "download": "Download the",
    "pdf": "PDF Files",
    "see": "See the",
    "html": "HTML Files",
    "number_of_session_files": 'Number of session files',
    "number_of_article_files": 'Number of article files',
    "separated_files_by_session": "2) Files separated by session",
    "click_to_download": "Click on the session to download the corresponding PDF file",
  ...
  "chair_eval_presentation":{
    ...
    "presentation_quality": 'Quality of the oral or poster presentation: ',
    ...
    "concerning": 'Concerning the pre-selection by the CS SGE of the contribution for publication in a partner international journal, are you:  ',
    "disadvantageous": "Disadvantageous",
    "mostly_disadvantageous": "Mostly Disadvantageous",
    "mostly_advantageous": "Mostly advantageous",
    "advantageous": "Advantageous",
    "obs": 'OBS: If the paper is pre-selected, a review will be carried out according to the rules of the partner journals (EJEE, EPE, EJAP). This review will be carried out by an ad-hoc committee on the basis of the complete English language version of the EMS article.',
    "optional_comments": 'Optional comments: ',
  },
  "chair_eval_session": {
    "session_summary": "Session Summary",
    "chairing_documents": "Chairing Documentation",
    "chairing_documents_description": "Documents to be distributed to the chairmen of each session for the evaluation of the sessions and presentations.",
    ...
    "session_chair": "Session Chair",
    "verify_your_name": "Verify your name (correct it as needed).",
    "number_of_presentations_carried_out": 'Number of presentations carried out: ',
    ...
    "excellent": "Excellent",
    "optional_comments": 'Optional comments: ',
    'committee': "The SGE organizing committee would like to thank you very much for your contribution and expertise, which were essential to the symposium..",
    "session": "Session",
    "article": "article"
  }, 
  "index":{
